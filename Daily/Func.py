...
def file_arrange():
    ...
    to_path = 'C:\\Users\Administrator\Desktop\\b'
    # to_path = 'C:\\Users\Administrator\Desktop\\{}{}{} 工作量'.format(nian, yue, ri_now)
    dx_name = 'C:\\Users\Administrator\Desktop\\电销统计'

    try:
        # os.rename(path, dx_name)  # 重命名文件名
        shutil.move(path, to_path)  # 移动到每日统计文件中
        os.mkdir(path)  # 新建统计文件夹
